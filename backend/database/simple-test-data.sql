-- SIMPLE TEST DATA MATCHING ACTUAL SCHEMA
...
-- Products
INSERT INTO products (id, name, description, short_description, sku, category_id, brand, price, compare_price, track_inventory, featured, created_at, updated_at, version) VALUES
(1, 'Laptop Pro 15"', 'High-performance laptop with 15" display, 16GB RAM, 512GB SSD', 'Premium laptop for professionals', 'LAPTOP-001', 1, 'TechBrand', 1299.99, 1499.99, 1, 1, NOW(), NOW(), 1);
